        ...
        <div className="shlok">
            {error ? (
                ...
                <div className="inner-content-div">
                    {props.sanskrit && <div className="slok devnagiri sanskrit">{sanskritShlok}</div>}
                    {props.english && <div className="slok english">{englishShlok}</div>}
                    {props.hindi && <div className="slok devnagiri hindi">{hindiShlok}</div>}
                </div>
            )}
        </div>
    );
